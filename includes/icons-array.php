...
function tpanel_custom_icons() {
    return array(
        ...
        'flaticon-ambulance',
        'flaticon-android-logo',
        'flaticon-app',
        'flaticon-apple-logo',
        'flaticon-arrows',
        'flaticon-arrows-1',
        'flaticon-bar-graph-with-dollar-sign',
        'flaticon-behance-logo',
        'flaticon-bold-button-of-letter-b-symbol',
        'flaticon-brick-wall',
        'flaticon-brick-wall-1',
        'flaticon-business-agreement',
        ...
        'flaticon-garbage',
        'flaticon-gear',
        'flaticon-google-logo',
        'flaticon-group',
        'flaticon-group-1',
        'flaticon-group-2',
        'flaticon-group-3',
        'flaticon-group-4',
        'flaticon-hand-graving-smartphone',
        'flaticon-handshake',
        'flaticon-happy-mac-logo',
        'flaticon-header-and-content-body-areas-layout',
        'flaticon-heart',
        'flaticon-helmet',
        'flaticon-home-page',
        'flaticon-html-5-logo',
        'flaticon-idea',
        'flaticon-interface',
        'flaticon-international-delivery',
        'flaticon-kettle',
        'flaticon-layout-of-gallery-with-header',
        'flaticon-layout-with-header-and-footer-areas',
        'flaticon-lightbulb',
        'flaticon-line-chart',
        'flaticon-loader',
        ...
        'flaticon-minus',
        'flaticon-minus-1',
        'flaticon-mobileme-logo-of-black-cloud',
        'flaticon-monitor-tablet-and-smartohone',
        'flaticon-monitor-with-text',
        'flaticon-networking',
        ...
        'flaticon-plus-1',
        'flaticon-pot',
        'flaticon-presentation-board-with-graph',
        'flaticon-programming',
        'flaticon-programming-code-signs',
        'flaticon-progress-report',
        'flaticon-red-cross',
        'flaticon-reload',
        'flaticon-restaurant',
        'flaticon-ruler',
        'flaticon-screw',
        'flaticon-screwdriver',
        ...
        'flaticon-share',
        'flaticon-share-1',
        'flaticon-sharethis-logo',
        'flaticon-shovel',
        'flaticon-signing-the-contract',
        'flaticon-smartphone-call',
        'flaticon-smartphone-receiving-sign',
        'flaticon-smartphone-sending-data',
        'flaticon-smartphone-with-email',
        'flaticon-smartphones-couple',
        'flaticon-social',
        'flaticon-star',
        ...
        'flaticon-tools-1',
        'flaticon-tooth',
        'flaticon-twitter-letter-logo',
        'flaticon-twitter-logo',
        'flaticon-unchecked',
        'flaticon-unchecked-1',
        'flaticon-upload',
        'flaticon-whatsapp-logo',
        'flaticon-whiteboard-with-header-and-two-footers',
        'flaticon-wifi-signal-tower',
        'flaticon-windows-8',
        'flaticon-woman-with-headset',
        'flaticon-wordpress-logo',
        'flaticon-yahoo-logo',
        'flaticon-youtube-play-button'
    );
}
